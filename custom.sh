...
user_name="root"                                    # 用户名
user_password="neovim42070"                         # 登录密码
lan_ip="192.168.8"                                 # LAN 地址 别写后面的 .1
wlan_2g_ssid="BiuBiuBiuBiu"                             # 2G 无线名称
wlan_5g_ssid="BiuBiuBiuBiu"                               # 5G 无线名称
wlan_guest_2g_ssid="int_pub_2.4G"                   # 2G 访客无线名称
wlan_guest_5g_ssid="int_pub_5G"                     # 5G 访客无线名称
wlan_2g_psk="neovim42070"                              # 2G WIFI密码最少8位 空白为不设置
wlan_5g_psk="neovim42070"                              # 5G WIFI密码最少8位 空白为不设置
